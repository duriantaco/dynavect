...
def generate_research_paper_figures(G, clip_model, device):
    ...
    seeds = [61, 121, 671,  993,  
    1121, 158, 1721, 2016, 2099, 3212, 4127, 645, 313, 1562, 1567,
    2526, 7272, 15121]
    ...
    edit_configs = [
    {"name": "Young_to_Old", "description": "Young → Old", "edits": [
        {"neutral": "a young person", "target": "an old person", "strength": 0.8}
    ]},
    {"name": "Old_to_Young", "description": "Old → Young", "edits": [
        {"neutral": "an old person", "target": "a young person", "strength": 0.8}
    ]},
    {"name": "Hair_Color", "description": "Dark → Blonde Hair", "edits": [
        {"neutral": "a person with dark hair", "target": "a person with dyed blonde hair", "strength": 1.2}
    ]},
    
    {"name": "Ethnicity_Change", "description": "Change to Asian", "edits": [
        {"neutral": "a caucasian face", "target": "an asian face", "strength": 1.2}
    ]},
