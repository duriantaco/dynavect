...
def generate_research_paper_figures(G, clip_model, device):
    ...
    seeds = [42, 95, 101, 126, 202, 333, 494, 525, 683, 707, 808, 909, 1010, 1154,
    1138, 1289, 1492, 1776, 1984, 2001, 2102, 2077, 2468, 3000, 3141, 4020, 4126,
    4242, 4540, 5001, 6711, 7890, 8008, 8675, 9021, 9990, 1123, 5800, 27, 349, 1171, 
    7891, 6519, 7872, 4142, 9091, 1442, 140, 145, 120, 298, 888, 323, 876, 1100, 1024, 
    2023, 3001, 7712, 8912, 11121, 11426, 2011, 4434, 8781, 5555, 7777, 9999, 9995, 1892,
    1131, 4359, 5762, 4141, 12345, 13131, 14421, 11378, 15678, 20241, 20092, 20011]
    ...
    edit_configs = [
        ...
        {"name": "Sad_Face", "description": "Sad Face", "edits": [{"neutral": "a face", "target": "a sad face", "strength": 1.4}]},
        {"name": "Angry_Face", "description": "Angry Face", "edits": [{"neutral": "a face", "target": "an angry old face", "strength": 1.4}]},
        {"name": "Age", "description": "Young -> Old", "edits": [{"neutral": "a young person", "target": "an old person", "strength": 0.8}]},
        {"name": "Age", "description": "Old -> Young", "edits": [{"neutral": "an old person", "target": "a young person", "strength": 0.8}]},
        {"name": "Hair_Color", "description": "Dark -> Blonde Hair", "edits": [{"neutral": "a woman with dark hair", "target": "a woman with dyed blonde hair", "strength": 1.2}]},
        {"name": "Combined", "description": "Smile + Age + Hair", "edits": [
            {"neutral": "a face", "target": "a smiling face", "strength": 0.9},
            {"neutral": "a young person", "target": "an old person", "strength": 0.8},
            {"neutral": "a person with dark hair", "target": "a person with dyed blonde hair", "strength": 1.2}
        ]}
    ]
